...
def compute_histogram(lbp, x = 4, y = 4):
    """
    Vypocte globalni histogram, rozdelen ctvercovou mrizkou na 4x4 kusy tz 16 dilu, a na tom vypocte 256 dlouhej histogram pro kazdy dil, 
    kdy nasledne histogramy zretezi. Pro vsechny smery.
    
    Keyword arguments:
        lbp -- lbp.
        x -- kolik dilu na delku.
        y -- kolik dilu na sirku.
    Return arguments:
        histograms -- zretezen globalni histogram.
    """
    histogram_size = 256
...
def compute_local_histogram(histogram, lbp, row_block, column_block, step_x, step_y, shift_direction, shift_block):
    """
    Vypocet lokalniho histogramu pro jeden dil.
    
    Keyword arguments:
        histogram -- do ktereho se dale budou ukladat jednotlive lokalni histogrami..
        lbp -- lbp.
        row_block -- block radek.
        column_block -- block ve sloupci.
        step_x -- velikost kroku v radku.
        step_y -- velikost kroku ve slloupci.
        shift_direction -- o kolik se to ma posunout pri zapisovani do lokalniho histogramu.
        shift_block -- o kolik se to ma posunout pri zapisovani do lokalniho histogramu.
    Return arguments:
        histograms -- zretezen globalni histogram.
    """
