...
for theta in orientations:
    #theta = theta / 4. * np.pi
    for frequency in wavelengths:
        kernel = gabor_kernel(1.0/frequency, theta=theta, sigma_x=sigma, sigma_y=sigma)
        #gabor_kernel(1.0/lambd, theta=theta, sigma_x=sigma, sigma_y=sigma)
