...
TRAIN_LIST = "../../Data/iaprtc12/iapr_train_2009_pulka_1.txt" # cesta k trenovacimu souboru. 
...
DATAFILE_TRAIN2 = "../result/iaprtc12_POEM_datafile_train_pulka_2.pyc" # pomucka pri malem poctu RAM
...
COUNT_NEIGHBORS = 8 # pocet knn (k nejblizsich sousedu)
