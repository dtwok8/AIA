...
%
\abstracttexten{This Bachelor thesis deals with automatic image annotation (AIA). Purpose is to verify choosen functions and try to find their improvements. One of used methods is Joint Equal Contribution and it's modification where were changed transporting keywords. One of other methods included is Patterns of Oriented Edge Magnitudes method and implementation of it's extensions including color and texture of image. Methods are described in theoretical part and implemented later. Achieved results are compared to literature at final phase. Testing run on data sets iaprtc12 and ESP.}
